    ...
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          <div className="relative flex">
            <input
              ...
              {...register('password')}
              // FIX: Added invisible class to hide the native Safari/Mac key icon
        ...
        <div className="mt-4 flex items-center justify-end text-sm">
          <div>
            <Link
              to={paths.auth['forget-password'].getHref(redirectTo)}
              className="text-text-primary hover:text-text-link-hover font-bold transition-colors hover:underline"
            >
              Forgot Password?
            </Link>
          </div>
